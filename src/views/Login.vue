                    ...
                    <v-row no-gutters>
                        <v-col col="12">
                            <div class="top-logo-display">
                                <img style="margin:0 !important" :src="require('../assets/svg/church-logo.svg')" class="my-3" contain height="150" width="150"/>
                    ...
                    <v-row no-gutters style="max-width:700px; margin:0 auto;">
                        <v-col col="12">
                            <div class="login-form-wraper">
                                <v-form ref="login_form" :lazy-validation="true" @submit.prevent="handleLogin">
